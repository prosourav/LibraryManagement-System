...
public class Home extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
        ...
        public Home() {
            ...
            ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("add.jpg"));
            ...
            l3 = new JLabel(i6);
            l3.setBounds(310, 160, 134, 128);
            contentPane.add(l3);

            JLabel l4 = new JLabel("");
            ImageIcon i7  = new ImageIcon(ClassLoader.getSystemResource("Add-student.png"));
            ...
            ImageIcon i10  = new ImageIcon(ClassLoader.getSystemResource("issue.jpg"));
            ...
            ImageIcon i13  = new ImageIcon(ClassLoader.getSystemResource("return.jpg"));
            Image i14 = i13.getImage().getScaledInstance(150, 150,Image.SCALE_DEFAULT);
            ImageIcon i15 = new ImageIcon(i14);
            l6 = new JLabel(i15);
            l6.setBounds(420, 440, 139, 152);
            contentPane.add(l6);
